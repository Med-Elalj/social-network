    ...
    <div key={Post.ID} className={Styles.post}>
      <section className={Styles.userinfo}>
        <div className={Styles.user}>
          {Post.GroupId?.Valid ? (
            <Image src={groupAvatar} alt="group avatar" width={25} height={25} />
          ) : (
            <Image src={authorAvatar} alt="author avatar" width={25} height={25} />
          )}
          ...
          <div className={Styles.texts}>
            {Post.GroupId?.Valid ? (
              <>
                ...
                <div className={Styles.user}>
                  <Image
                    src={Post.AvatarUser.Valid ? Post.AvatarUser.String : "/iconMale.png"}
                    alt="avatar"
                    width={20}
                    height={20}
                  />
